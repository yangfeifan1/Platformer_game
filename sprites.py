# Sprite classes foe platform game
...
class Player(pg.sprite.Sprite):
    ...
    def animate(self):
        ...
        self.mask = pg.mask.from_surface(self.image) # get mask of player
        #show idea animation
        if not self.jumping and not self.walking:
            if now - self.last_updata > 350:
                self.last_updata = now
...
class Mob(pg.sprite.Sprite):
    ...
    def update(self):
        ...
        self.rect = self.image.get_rect()
        self.mask = pg.mask.from_surface(self.image)  # get mask to hit
